...
class Agent(object):
    ...
    # Set up the agent by obtaining parameters and initializing empty Q-tables.
...
class QLearningAgent(Agent):
    ...
    def step(self, state_dict, actions_dict):
        ...
        # Select the best next action based on the specified policy.
        # Required parameters:
        ...
        # Transform state dictionary into tuple
    ...
    def update(self, state_dict, action):
        ...
        # Set prev_state unless first turn
...
class MonteCarloAgent(Agent):
    ...
    # Select the best next action based on the followed policy.
    # Required parameters:
    #   - state_dict: dictionary
    #   - actions_dict: dictionary
