...
from utils import check_win, block_print, enable_print, bold
import config as conf


class Game(object):
# A game represents an iteration of turns until one player fulfills the winning condition of having 0 hand cards.
# It is initialized with two players and a turn object.
...
# A function that iterates through various games and provides summary statistics over all executed simulations.
